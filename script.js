...
const mammaQuotes = [
    ...
    "Ditt barn räknar inte perfekta dagar.",
    "Att finnas där räcker långt.",
    ...
    "Att du bryr dig säger redan mycket.",
    "Ditt barn känner sig älskat oftare än du tror.",
    "Du får göra saker på ditt sätt.",
    ...
    "Ditt barn behöver inte en glad mamma varje minut. Det behöver en sann mamma.",
    "Ni lär er tillsammans, dag för dag.",
    "Små framsteg är också framsteg.",
    "Du räcker längre än dina tvivel säger.",
    "Det finns inget facit för kärlek.",
    ...
    "Ditt barn ser inte dina brister på samma sätt som du gör.",
    "Du är hemma för någon.",
