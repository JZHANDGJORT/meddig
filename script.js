...
const mammaQuotes = [
    "Du gör tillräckligt.",
    "Du räcker redan.",
    "Du gör redan mer än du tror.",
    "Du gör mer rätt än du själv ser.",
    "Du gör ett viktigare jobb än du själv kan se.",

    "Ditt barn behöver inte en perfekt mamma.",
    "Ditt barn behöver inte en perfekt mamma. Bara dig.",
    "Ditt barn behöver inte perfektion. Det behöver dig.",
    "Ditt barn behöver inte att du är perfekt. Det behöver att du finns.",
    "Ditt barn behöver din närhet mer än din perfektion.",
    "Du är precis den mamma ditt barn behöver.",

    "Du får vila när du kan.",
    "Vila när du kan. Resten kan vänta.",
    "Vila är också omsorg.",
    "Vila är också en del av att ta hand om sitt barn.",
    "Små stunder av vila räknas också.",
    "Ett lugnt andetag räcker långt ibland.",

    "Du får vara trött.",
    "Du får längta efter en paus.",
    "En paus förändrar inte hur mycket du älskar ditt barn.",
    "Det är okej om det känns överväldigande ibland.",
    "Det är okej om vissa dagar bara handlar om att ta sig igenom dem.",
    "Det finns dagar som bara behöver få vara.",
    "Det finns dagar då kärlek ser ut som att bara ta sig igenom dagen.",

    "Du behöver inte njuta av varje minut för att vara en fantastisk mamma.",
    "Det är okej att inte älska varje minut.",
    "Det är okej att känna många saker samtidigt.",
    "Du får känna många känslor samtidigt.",
    "Det är okej att tvivla ibland.",
    "Du är inte ensam om att känna dig osäker ibland.",

    "Du behöver inte bära allt ensam.",
    "Det är inte meningen att du ska bära allt själv.",
    "Det är okej att be om hjälp.",
    "Att be om hjälp är också omsorg.",
    "Du får be om hjälp innan du är helt slut.",

    "Du är fortfarande du, även om allt har förändrats.",
    "Du får sakna den du var och samtidigt älska den du håller på att bli.",
    "Du behöver inte hinna tillbaka till den du var.",
    "Du får vara snäll mot dig själv också.",
    "Du räcker längre än dina tvivel säger.",
    "När du tror att du inte räcker till är det ofta bara tröttheten som pratar.",

    "Ni lär känna varandra lite mer varje dag.",
    "Ni lär er tillsammans, dag för dag.",
    "Det räcker att ni hittar er egen rytm.",
    "Du lär känna ditt barn, och ditt barn lär känna dig.",
    "Ni behöver inte ha alla svar idag.",
    "Du får följa din egen magkänsla.",
    "Ingen känner ditt barn som du gör.",
    "Du behöver inte jämföra er resa med någon annans.",

    "Små stunder av närhet betyder mer än du tror.",
    "En stund tillsammans är aldrig bortkastad.",
    "En kram räcker längre än många ord.",
    "Kärlek syns ofta i det allra vanligaste.",
    "Kärlek finns ofta i de små vardagliga stunderna.",
    "Det viktigaste du ger går inte att mäta.",
    "Ditt barn känner sig älskat oftare än du tror.",
    "Ditt barn minns känslan av att vara älskat.",
    "Du ser kanske allt du inte hann idag. Ditt barn såg att du var där.",
    "Ditt barn behöver inte minnas en perfekt dag. Det kommer minnas hur det kändes att vara hos dig.",

    "Du behöver inte hinna allt idag.",
    "Det är okej att låta disken vänta.",
    "Du behöver inte vara allt på en gång.",
    "Du behöver inte göra mer för att vara en bra mamma.",
    "Du är viktigare än den perfekta rutinen.",
    "Det är okej att sänka kraven ibland.",

    "Det finns inget perfekt sätt att vara mamma.",
    "Kärlek följer inget facit.",
    "Det finns styrka i att vara mjuk.",
    "För någon är du hemma.",
    "Du är den trygga plats någon alltid kommer att söka sig till.",
    "Din kropp har gjort något stort.",
    "Den här tiden är stor, även när dagarna känns små.",
    "En tung dag säger ingenting om vilken mamma du är.",
    "Du får känna stolthet över det lilla.",
    "Det är okej att börja om efter en tuff dag.",
    "Du behöver inte bära morgondagen idag.",
...
// ===============================
    ...
    "Du behöver inte tänka färdigt alla tankar.",
        "Du kan börja med ett enda andetag.",
"Känn hur stolen bär dig.",
"Du behöver inte skynda den här stunden.",
"Låt axlarna få bli lite tyngre.",
"Du behöver inte lämna den här stunden i tanken.",
"Lägg märke till något du kan se.",
"Känn fötterna mot marken.",
"Det är okej att bara observera en stund.",
"Du får komma tillbaka hit, just nu.",
"Lyssna efter ett ljud i närheten.",
"Låt andetaget få vara precis som det är.",
"Du behöver inte förändra något just nu.",
"Känn hur luften känns mot huden.",
"Det här ögonblicket behöver inget av dig.",
"Det finns mark under dig.",
"Du får vila blicken en liten stund.",
"Låt kroppen få komma ikapp.",
"Du behöver inte tänka längre än den här stunden.",
"Du kan stanna upp utan att något blir fel.",
"Det är ingen brådska här.",
"Du får bara lägga märke till det som finns omkring dig.",
"Du behöver inte göra något med det du känner.",
"En stund i taget räcker.",
"Låt nästa andetag komma av sig självt.",
"Det är okej att bara finnas här.",
"Du behöver inte förstå allt för att vara här.",
"Lägg märke till hur kroppen möter underlaget.",
"Du kan släppa taget om nästa minut en liten stund.",
"Den här stunden får vara precis som den är.",
"Du behöver inte komma någon annanstans just nu."
];
const landaKindnessQuotes = [
    ...
    "Du behöver inte vara hård mot dig själv.",
"Du får ta det lugnare än du tror.",
"Det är okej om allt känns lite mycket.",
"Du behöver inte bära allt ensam just nu.",
"Det är okej att inte orka hela vägen idag.",
"Du får vila utan att förtjäna det först.",
"Du behöver inte ha svar på allt.",
"Du får känna det du känner.",
"Det är okej att inte vara stark hela tiden.",
"Du behöver inte göra mer just nu.",
"Du får vara snäll mot dig själv idag.",
"Det är okej att ta en paus.",
"Du behöver inte bevisa något för den här stunden.",
"Du får släppa kravet på att räcka till överallt.",
"Du behöver inte ha allt under kontroll.",
"Det är okej att ta en sak i taget.",
"Du får låta kroppen få vila en stund.",
"Du behöver inte bära gårdagen med dig just nu.",
"Det är okej att vara där du är.",
"Du får vara precis som du är i den här stunden.",
"Du behöver inte skynda på läkningen.",
"Det är okej att behöva återhämtning.",
"Du får ge dig själv samma omtanke som du skulle ge någon annan.",
"Du behöver inte göra allt perfekt.",
"Det är okej att vara ofärdig.",
"Du får vara vänlig mot dig själv även idag.",
"Du behöver inte kämpa för att förtjäna vila.",
"Det är okej att mjukna lite.",
"Du får släppa taget om kraven för en stund.",
...
const landaHopeQuotes = [
    ...
    "Det här ögonblicket är inte hela berättelsen.",
"Du behöver inte känna hopp hela tiden för att det ska finnas där.",
"Det finns fler stunder än den här.",
"Du har klarat svåra stunder tidigare.",
"Du behöver inte ta hela vägen idag.",
"Det får ta tid.",
"Nästa stund behöver inte kännas likadan.",
"Du får fortsätta i din egen takt.",
"Det är okej att bara ta nästa lilla steg.",
"Du behöver inte veta hur det blir för att fortsätta framåt.",
"Lugnet kan hitta tillbaka, steg för steg.",
"Det finns plats för en lättare stund längre fram.",
"Du behöver inte känna dig stark för att fortsätta.",
"Varje andetag är också ett steg framåt.",
"Det finns dagar som känns lättare än den här.",
"Du får vila innan du fortsätter.",
"Det är okej att hoppas försiktigt.",
"Det finns fortfarande saker du ännu inte har upplevt.",
"Du behöver inte bära den här känslan för alltid.",
"Små förändringar får också räknas.",
"Det är okej om det går långsamt.",
"Du får ge dig själv tid.",
"Du behöver inte tro på hela framtiden. Bara nästa steg.",
"Det finns fortfarande utrymme för något gott.",
"Den här stunden får passera i sin egen takt.",
"Du behöver inte känna dig redo för att fortsätta.",
"Det är okej om hoppet känns litet idag.",
"Det finns fler kapitel kvar.",
"Det är inte för sent att börja om.",
"Du får lita på att allt inte behöver avgöras idag."
];
const landaSafetyQuotes = [
    ...
    "Du får slappna av en liten stund.",
"Du behöver inte vara beredd på allt.",
"Den här stunden kräver ingenting av dig.",
"Du får låta kroppen vila.",
"Det finns inget du behöver hinna just nu.",
"Du får känna att marken bär dig.",
"Du behöver inte hålla ihop allt.",
"Du får vara stilla en stund.",
"Det finns plats för lugn här.",
"Du behöver inte skydda dig mot den här stunden.",
"Du får släppa taget lite grann.",
"Du behöver inte vara vaksam hela tiden.",
"Det är okej att låta andetaget bli lite djupare.",
"Du får ge kroppen en stund av vila.",
"Det finns inget som måste lösas just nu.",
"Du får känna att du är buren av den här stunden.",
"Du behöver inte hålla emot.",
"Du får vila från kraven en liten stund.",
"Det finns inget du behöver prestera här.",
"Du får känna efter utan att förändra något.",
"Det är okej att mjukna lite.",
"Du får låta den här stunden vara enkel.",
"Det finns inget du behöver göra för att få vila.",
"Du får vara trygg nog precis här.",
"Det är okej att bara finnas en stund.",
"Du behöver inte vara redo för allt som kommer sedan.",
"Du får låta lugnet ta lite mer plats.",
"Den här stunden får bära dig en liten bit.",
"Du behöver inte hålla andan längre.",
"Du får känna att du är här, och att det räcker."
];
// ===============================
// ⏰ DYGN
// ===============================
